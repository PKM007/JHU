...
//                    Incident incident = new Incident(longitude, latitude, description, 0, dateAndTime, location, 2);
    ...
    public static void main(String[] args) {
        ...
        Spark.get("/googleLogin", (req, res) -> {
            Map<String, Object> model = new HashMap<>();
            URL urlForGetRequest = new URL("https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=http://localhost:7000&scope=https://www.googleapis.com/auth/userinfo.profile&response_type=code&client_id=649384552528-c9ej84f58ijleb0o16rrpnqcsrns3c7u.apps.googleusercontent.com");
...
//            else {
    ...
    private static void googleAuth() throws IOException {
...
//        URL url = new URL("https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=http://localhost:7000&client_id=649384552528-c9ej84f58ijleb0o16rrpnqcsrns3c7u.apps.googleusercontent.com");
